...
def create_item(shopify_item, warehouse, has_variant=0, attributes=None,variant_of=None, shopify_item_list=[]):
	...
	if not has_duplicate_item(item_dict, attributes):
...
def has_duplicate_item(shopify_item, attributes=None):	
	item = frappe.get_doc("Item", {"item_name": shopify_item.get("item_name"), "sync_with_shopify": 1})
